...
import BarcodeScannerComponent from '../../components/barcodeScanner/barcodeScanner.jsx';

import './addReceipt.scss';

function AddReceiptTest() {
          ...
          {showScanner && (
            <BarcodeScannerComponent
              ...
              onScanSuccess={(scannedValue) => {
                ...
                // Nếu bạn muốn tự động thêm sách khi quét xong:
                const book = books.find((b) => b.id_product.toString() === scannedValue);
                if (book) {
                  handleAddBook(book);
                  setSearchTerm('');
                  if (inputRef.current) inputRef.current.value = '';
